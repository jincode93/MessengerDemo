...
struct StubUserDBReference: DBReferenceType {
    ...
    func setValue(key: String, path: String?, value: Any) -> AnyPublisher<Void, Messenger.DBError> {
    ...
    func setValues(_ values: [String : Any]) -> AnyPublisher<Void, Messenger.DBError> {
        Just(()).setFailureType(to: DBError.self).eraseToAnyPublisher()
    }
    
    func fetch(key: String, path: String?) -> AnyPublisher<Any?, Messenger.DBError> {
    ...
    func filter(key: String, path: String?, orderedName: String, queryString: String) -> AnyPublisher<Any?, Messenger.DBError> {
    ...
    func observeChildAdded(key: String, path: String?) -> AnyPublisher<Any?, Messenger.DBError> {
        Just(nil).setFailureType(to: DBError.self).eraseToAnyPublisher()
    }
