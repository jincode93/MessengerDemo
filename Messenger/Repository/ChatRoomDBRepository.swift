...
protocol ChatRoomDBRepositoryType {
    ...
    func updateChatRoomLastMessage(chatRoomId: String, myUserId: String, myUserName: String, otherUserId: String, lastMassage: String) -> AnyPublisher<Void, DBError>
}
...
class ChatRoomDBRepository: ChatRoomDBRepositoryType {
    ...
    func updateChatRoomLastMessage(chatRoomId: String, myUserId: String, myUserName: String, otherUserId: String, lastMassage: String) -> AnyPublisher<Void, DBError> {
        Future { [weak self] promise in
            let values = [
                "\(DBKey.ChatRooms)/\(myUserId)/\(otherUserId)/lastMessage" : lastMassage,
                "\(DBKey.ChatRooms)/\(otherUserId)/\(myUserId)/lastMessage" : lastMassage,
